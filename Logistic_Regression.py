...
for bt in range(boostrapping_time):
    ...
    joblib.dump(lr_grid, "save_model\\LogisticRegression\\logistic_regression_train_model_%d.m" % (bt))
    joblib.dump(count_vec,"save_model\\LogisticRegression\\logistic_regression_count_vec_%d.m" % (bt))
    et = time()
...
summary.to_excel("save_model\\LogisticRegression\\logistic_regression_hyperselection_info_sample%d.xls") % (sample_num)
print('all done!')
