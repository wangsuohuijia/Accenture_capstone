...
for j in range(0,50):
    ...
    ###### TODO - transform probability into sentiment_strength on lr
    lr_Ubuntu_sentiment_pred_prob_matrix= pd.DataFrame(lr_Ubuntu_sentiment_pred_prob)
    Ubuntu_test['LR_sentiment_strength'] = lr_Ubuntu_sentiment_pred_prob_matrix[1] - lr_Ubuntu_sentiment_pred_prob_matrix[0]


    ###### TODO - transform probability into sentiment_strength on rf
    rf_Ubuntu_sentiment_pred_prob_matrix= pd.DataFrame(rf_Ubuntu_sentiment_pred_prob)
    Ubuntu_test['RF_sentiment_strength'] = rf_Ubuntu_sentiment_pred_prob_matrix[1] - rf_Ubuntu_sentiment_pred_prob_matrix[0]

    ######### TODO - calculate the correlation
    temp = Ubuntu_test[['LR_sentiment_strength', 'RF_sentiment_strength']]
