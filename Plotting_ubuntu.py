...
for i in range(1,23):
    ...
    plt.suptitle('LR_sentiment changes for customer and oracle (%d)' % (i+20), fontsize=25)
    # plt.show()
    ...
    plt.suptitle('RF_sentiment changes for customer and oracle (%d)' % (i+20), fontsize=25)
    # plt.show()
